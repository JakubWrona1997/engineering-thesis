...
export default function CommunicationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCommunication_type(initialValues.communication_type);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Communication(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CommunicationCreateForm")}
      {...rest}
    >
      <SelectField
